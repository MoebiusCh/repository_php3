...
@section('content')
            ...
            <div class="relative">
                <ul class="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
                    <li class="flex items-center space-x-3 text-left sm:space-x-4">
                        ...
                        <span class="font-semibold text-gray-900">Cửa hàng</span>
                    </li>
                    ...
                    <li class="flex items-center space-x-3 text-left sm:space-x-4">
                        <a class="flex h-6 w-6 items-center justify-center rounded-full bg-gray-400 text-xs font-semibold text-white"
                            href="#">3</a>
                        <span class="font-semibold text-gray-500">Hoàn tất</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div class="px-4 pt-8">
            ...
            <p class="text-gray-400">Kiểm tra sản phẩm và chọn phương thức thanh toán phù hợp</p>
            ...
            <form class="mt-5 grid gap-6">
                <div class="relative">
                    ...
                    <label
                        ...
                        <div class="ml-5">
                            <span class="mt-2 font-semibold">Giao hàng tận nơi</span>
                            <p class="text-slate-500 text-sm leading-6">Ước tính: 2-4 Ngày</p>
                        </div>
                    </label>
                </div>
            </form>
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <p class="text-gray-400">Cung cấp thông tin chi tiết để hoàn thành đơn đặt hàng của bạn</p>
            <div class="">
                <label for="email" class="mt-4 mb-2 block text-sm font-medium">Email</label>
                <div class="relative">
                    <input type="text" id="email" name="email"
                        class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                        placeholder="email.cuaban@gmail.com" />
                ...
                <label for="card-holder" class="mt-4 mb-2 block text-sm font-medium">Tên của bạn</label>
                <div class="relative">
                    ...
                    <div class="relative flex-shrink-0 sm:w-7/12">
                        ...
                        <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                            <img class="h-4 w-4 object-contain"
                                src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Flag_of_Vietnam.svg/1200px-Flag_of_Vietnam.svg.png?20170626140925" alt="" />
                        </div>
                    </div>
                    <select type="text" name="billing-state"
                        class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500">
                        <option value="State">Tỉnh/TP</option>
                    </select>
