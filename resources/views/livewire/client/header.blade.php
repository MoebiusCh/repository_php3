    ...
    <nav class="mx-52 flex justify-between py-4 text-slate-400">
        <div class="left flex place-items-center content-center space-x-10">
            <div class="hover:text-slate-50">
                <a href="/" wire:navigate>Logo</a>
            </div>
            <div class="hover:text-slate-50">
                <a href="/" wire:navigate>Trang chủ</a>
            </div>
            <div class="hover:text-slate-50">
                <a href="{{ route('shop') }}" wire:navigate>Cửa hàng</a>
            </div>
            <div class="hover:text-slate-50">
                <a href="{{ route('tintuc') }}" wire:navigate>Tin tức</a>
            </div>
            <div class="hover:text-slate-50">
                <a href="" wire:navigate>Phản hồi</a>
            </div>
            <div class="hover:text-slate-50">
                <a href="" wire:navigate>Đơn hàng</a>
            </div>
        </div>
        <div class="content-centerright flex place-items-center space-x-2">
            ...
            <div id="cart" class="flex space-x-2 rounded-lg bg-[#2a2a2a] p-2">
                <a href="{{ route('cart') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="h-6 w-6 cursor-pointer fill-white">
            ...
            @if (Session::get('user_info'))
                <div class="">
                    <details class="dropdown">
                        <summary class="m-1 btn"> {{ Session::get('user_info')->name }}</summary>
                        <ul class="p-2 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-52">
                            @if (Auth::user()->role == 0)
                                <li><a href="{{ route('admin.dashboard') }}">Trang Dashboard</a></li>
                            @endif
